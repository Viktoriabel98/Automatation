...
class ShopContainer:
    ...
    def into(self):
        ...
        self.browser.find_element(*self.first_name).send_keys("Viktoria")
        self.last_name = (By.ID, "last-name")
        self.browser.find_element(*self.last_name).send_keys("Vasyura")
    ...
    def price(self):
        WebDriverWait(self.browser, 10, 0.1).until(EC.presence_of_all_elements_located((By.CSS_SELECTOR, ".summary_total_label")))
