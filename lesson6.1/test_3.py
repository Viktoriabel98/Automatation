...
def test_shop_form(chrome_browser):
    ...
    chrome_browser.find_element(By.ID, "first-name").send_keys("Viktoria")
    chrome_browser.find_element(By.ID, "last-name").send_keys("Vasyura")
    ...
    total = total_price.text.strp().replace("Total: $", "")
